 ...
 * Trait Importable
 *
 * Provides data import capabilities for Eloquent models.
 * Supports CSV, JSON, and Excel formats with validation and preview functionality.
 *
 * Usage:
 * ```php
 ...
 *
 * // Import from CSV
 * $imported = Product::importFromCsv('products.csv', ['SKU' => 'sku', 'Name' => 'name']);
 *
 * // Preview before importing
 * $preview = Product::previewImport('products.csv', 'csv', $mapping, 10);
 *
 * // Validate file
 * $validation = Product::validateImportFile('products.csv', 'csv', $mapping);
 * ```
 *
