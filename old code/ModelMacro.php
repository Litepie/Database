...
class ModelMacro
{
    ...
    /**
     * Register advanced relationship macros.
     */
    protected function registerRelationshipMacros()
    {
        Builder::macro('hasManyDeep', function ($related, $through, $firstKey, $secondKey) {
            // Example: return $this->hasManyThrough($related, $through, $firstKey, $secondKey);
            // You can expand this for more complex relationships as needed.
            return $this->hasManyThrough($related, $through, $firstKey, $secondKey);
        });

        Builder::macro('belongsToThrough', function ($related, $through, $firstKey, $secondKey) {
            // Example: return $this->belongsToMany($related, $through, $firstKey, $secondKey);
            // You can expand this for more complex relationships as needed.
            return $this->belongsToMany($related, $through, $firstKey, $secondKey);
        });
    }
